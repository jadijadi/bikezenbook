...
ترمزهای لقمه‌ای با فشرده شدن دسته ترمز، به طوقه چرخ نزدیک می‌شوند و با کشیده شدن به بخش فلزی طوقه، سرعت دوچرخه را کم می‌کنند. در مقابل ترمزهای دیسکی برای متوقف کردن دوچرخه از یک دیسک مستقل که فقط برای ترمز به توپی چرخ شده استفاده می‌کنند و در نتیجه مزایایی مثل ترمز قوی‌تر یا عدم بروز مشکل در مواقع بارندگی و غیره را دارند.
