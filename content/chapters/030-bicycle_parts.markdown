...
![اجزای دوچرخه کامل, تصویر 1]({filename}/images/parts_full.jpg)

![اجزای دوچرخه کامل, تصویر 2]({filename}/images/parts_full2.jpg)

## ۱- بدنه یا تنه

![اجزای دوچرخه - بدنه]({filename}/images/parts_1.jpg)
...
![اجزای دوچرخه - بدنه GT]({filename}/images/body_gt.jpg)

## ۲- دوشاخ

![اجزای دوچرخه - دوشاخ]({filename}/images/parts_2.jpg)
...
![کرپی فرمان]({filename}/images/parts_4.jpg)
...
![زین یا صندلی]({filename}/images/parts_5.jpg)
...
![لوله زین]({filename}/images/parts_6.jpg)
...
![لاستیک یا تایر]({filename}/images/parts_7.jpg)
...
![طوقه]({filename}/images/parts_8.jpg)
...
![پنجه رکاب]({filename}/images/parts_9.jpg)
...
![طبق قامه]({filename}/images/parts_10.jpg)
...
![شانژمان (دستگاه تعویض دنده عقب)]({filename}/images/parts_11.jpg)
...
![طبق عوض کن (دستگاه تعویض دنده جلو)]({filename}/images/parts_12.jpg)
...
![دسته دنده]({filename}/images/parts_13.jpg)

اهرمی است که با فشردن آن‌، شانژمان یا طبق عوض کن حرکت می‌کند و زنجیر را روی چرخ‌دنده‌های مختلف حرکت می‌دهد. انواع دسته‌دنده وجود دارد. گاهی در مدل‌های ساده‌تر با چرخاندن یک چرخ روی دسته، دنده عوض می‌کنید و گاهی با کشیدن اهرم‌ها، مستقیما شانژمان را هل می‌دهید. اگر دوچرخه‌ای می‌خرید از فروشنده بخواهید به شما نشان‌دهد که کدام دنده در کدام جهت با کدام دسته‌دنده حرکت می‌کند. معمولا برای تنظیم دنده یک اهرم برای پر کردن و یک اهرم برای خالی کردن دنده استفاده می‌شود پس دوچرخه‌ای که هم در جلو و هم در عقب دنده دارد، چهار دسته دنده لازم دارد.

## ۱۴- دسته ترمز

![دسته ترمز]({filename}/images/parts_14.jpg)
...
![ترمز (دیسکی و لقمه‌ای)]({filename}/images/parts_15.jpg)
...
![خودرو]({filename}/images/parts_16.jpg)
...
![زنجیر]({filename}/images/parts_17.jpg)
...
![توپی چرخ (HUB)]({filename}/images/Hub.jpg)
...
- در صورت استفاده در محیط های آلوده ( در معرض آب / گل / گرد و خاک ) خیلی سریع نیاز به سرویس پیدا می کند و در صورت وجود کثیفی و ذرات گرد و غبار در داخل آن به سطوح صیقلی آن آسیب وارد می شود
...
- همیشه در حالت تنظیم 100 % است به خاطر یک پارچه بودن بلبرینگ ( یعنی کاسه و گیو و ساچمه هایش چون همه در غالب یک قطعه ( بلبرینگ اند ) هرگز از تنظیم خارج نمی شود ) شاید توپی ساچمه ایی وقتی سرویس و تنظیم شده باشد از بلبرینگ روانتر باشد ولی این حالت بیش از دو هفته دوام نمی آورد و کارایی توپی ساچمه بعد از دو هفته اول سرویس و تنظیم به زیر 80 % نزول می کند. که در حال حاضر با بکار گیری بلبرینگ های کونیکیو زاویه دار و استفاده از ساچمه های روکش دار در بلبرینگ روانی حرکت اونها رو هم اینقدر افزایش دادند که باز از ساچمه های معمولی پیش می گیرند.
